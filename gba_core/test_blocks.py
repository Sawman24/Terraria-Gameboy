...
blocks = [
     r"c:\Users\sawye\Desktop\Terraria Beta\GBA_Assets\Tiles\Tiles_0.png", # Dirt
     r"c:\Users\sawye\Desktop\Terraria Beta\GBA_Assets\Tiles\Tiles_1.png", # Stone
]
for p in blocks:
    if os.path.exists(p):
        img = Image.open(p).convert("RGBA")
        crop = img.crop((9, 9, 17, 17))
